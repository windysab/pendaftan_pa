            ...
            <form method="POST" action="{{ isset($permohonan) ? route('permohonan.update', $permohonan->id) : route('permohonan.store') }}">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4>Data Calon Mempelai Suami</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="nama_calon_suami">Nama</label>
                                ...
                                <div class="form-group">
                                    <label for="tanggal_lahir_calon_suami">Tanggal Lahir</label>
                                ...
                                <div class="form-group">
                                    <label for="pekerjaan_calon_suami">Pekerjaan</label>
                                ...
                                <div class="form-group">
                                    <label for="pendidikan_calon_suami">Pendidikan</label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4>Data Calon Mempelai Isteri</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="nama_calon_isteri">Nama</label>
                                ...
                                <div class="form-group">
                                    <label for="tanggal_lahir_calon_isteri">Tanggal Lahir</label>
                                ...
                                <div class="form-group">
                                    <label for="pekerjaan_calon_isteri">Pekerjaan</label>
                                ...
                                <div class="form-group">
                                    <label for="pendidikan_calon_isteri">Pendidikan</label>
                                ...
                                <div class="form-group">
                                    <label for="alamat_calon_isteri">Alamat</label>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4>Data Calon Suami Isteri</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="tempat_menikah">Tempat Menikah (ditolak)</label>
                                ...
                                <div class="form-group">
                                    <label for="no_surat_penolakan">No Surat Penolakan KUA</label>
                                ...
                                <div class="form-group">
                                    <label for="lama_hubungan">Lama Hubungan Calon</label>
                                ...
                                <div class="form-group">
                                    <label for="penghasilan_suami">Penghasilan Perbulan Calon Suami</label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4>Data Mertua Laki-laki</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="nama_mertua_laki">Nama</label>
                                ...
                                <div class="form-group">
                                    <label for="umur_mertua_laki">Umur</label>
                                ...
                                <div class="form-group">
                                    <label for="pekerjaan_mertua_laki">Pekerjaan</label>
                                ...
                                <div class="form-group">
                                    <label for="pendidikan_mertua_laki">Pendidikan</label>
                                ...
                                <div class="form-group">
                                    <label for="alamat_mertua_laki">Alamat</label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4>Data Mertua Perempuan</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="nama_mertua_perempuan">Nama</label>
                                ...
                                <div class="form-group">
                                    <label for="umur_mertua_perempuan">Umur</label>
                                ...
                                <div class="form-group">
                                    <label for="pekerjaan_mertua_perempuan">Pekerjaan</label>
                                ...
                                <div class="form-group">
                                    <label for="pendidikan_mertua_perempuan">Pendidikan</label>
                                ...
                                <div class="form-group">
                                    <label for="alamat_mertua_perempuan">Alamat</label>
