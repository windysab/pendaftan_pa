...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            @endif
            <form method="POST" action="{{ isset($gugatan) ? route('gugatan.update.page3', $gugatan->id) : route('gugatan.store') }}">
                @csrf
                @if(isset($gugatan))
                    @method('PUT')
                @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="desa_meninggalkan"><b>Desa</b></label>
...
<script>
    ...
    //     var alasan = document.getElementById('alasan_perselisihan').value;
    //     var textareaContainer = document.getElementById('textarea-container');
    //     if (alasan === 'alasan_lainnya') {
