                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="alasan_meninggalkan" id="diusir" value="diusir"
                                                        required>
                                                    <label class="form-check-label" for="diusir"><b>Karena diusir
                                                            oleh</b></label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="alasan_meninggalkan" id="keinginan_sendiri"
                                                        value="keinginan_sendiri" required>
