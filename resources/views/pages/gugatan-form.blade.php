                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="rumah_sendiri">
                                                Di rumah sendiri, di desa <input type="text" name="desa_rumah_sendiri" class="form-control">
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="rumah_orangtua_penggugat">
                                                Di rumah orangtua Penggugat, di desa <input type="text" name="desa_rumah_orangtua_penggugat" class="form-control">
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="rumah_orangtua_tergugat">
                                                Di rumah orangtua Tergugat, di desa <input type="text" name="desa_rumah_orangtua_tergugat" class="form-control">
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="rumah_kontrakan">
                                                Di rumah kontrakan / kos, di desa <input type="text" name="desa_rumah_kontrakan" class="form-control">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
