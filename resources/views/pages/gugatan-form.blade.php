                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="alamat_penggugat" name="alamat_penggugat" class="form-control" data-height="100" readonly onclick="openPenggugatAddressModal()"></textarea>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="alamat_tergugat" name="alamat_tergugat" class="form-control" data-height="100" readonly onclick="openAddressModal()"></textarea>
