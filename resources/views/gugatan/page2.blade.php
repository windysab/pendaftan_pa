...
@section('main')
    <div class="main-content">
        <section class="section">
            ...
            @csrf --}}
                <form method="POST"
                    action="{{ isset($gugatan) ? route('gugatan.edit.page3', $gugatan->id) : route('gugatan.page3') }}"
                    onsubmit="validateForm(event)" id="gugatanForm2">
                    @csrf
                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="hari_pernikahan" name="hari_pernikahan"
                                                    class="form-control"
                                                    value="{{ old('hari_pernikahan', $gugatan->hari_pernikahan ?? '') }}"
                                                    readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="tanggal_pernikahan" name="tanggal_pernikahan"
                                                    class="form-control"
                                                    value="{{ old('tanggal_pernikahan', $gugatan->tanggal_pernikahan ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="desa_pernikahan" name="desa_pernikahan"
                                                    class="form-control"
                                                    value="{{ old('desa_pernikahan', $gugatan->desa_pernikahan ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kecamatan_pernikahan" name="kecamatan_pernikahan"
                                                    class="form-control"
                                                    value="{{ old('kecamatan_pernikahan', $gugatan->kecamatan_pernikahan ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kabupaten_pernikahan" name="kabupaten_pernikahan"
                                                    class="form-control"
                                                    value="{{ old('kabupaten_pernikahan', $gugatan->kabupaten_pernikahan ?? '') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nomor_akta_nikah" name="nomor_akta_nikah"
                                                    class="form-control"
                                                    value="{{ old('nomor_akta_nikah', $gugatan->nomor_akta_nikah ?? '') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="tanggal_akta_nikah" name="tanggal_akta_nikah"
                                                    class="form-control"
                                                    value="{{ old('tanggal_akta_nikah', $gugatan->tanggal_akta_nikah ?? '') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kecamatan_kua" name="kecamatan_kua"
                                                    class="form-control"
                                                    value="{{ old('kecamatan_kua', $gugatan->kecamatan_kua ?? '') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="kabupaten_kua" name="kabupaten_kua"
                                                    class="form-control"
                                                    value="{{ old('kabupaten_kua', $gugatan->kabupaten_kua ?? '') }}">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tempat_tinggal" id="tempat_tinggal"
                                            onchange="toggleDesaInput()">
                                            <option value="">Pilih tempat tinggal</option>
                                            <option value="rumah_sendiri"
                                                {{ old('tempat_tinggal', $gugatan->tempat_tinggal ?? '') == 'rumah_sendiri' ? 'selected' : '' }}>
                                                Di rumah sendiri, di desa</option>
                                            <option value="rumah_orangtua_penggugat"
                                                {{ old('tempat_tinggal', $gugatan->tempat_tinggal ?? '') == 'rumah_orangtua_penggugat' ? 'selected' : '' }}>
                                                Di rumah orangtua Penggugat, di desa</option>
                                            <option value="rumah_orangtua_tergugat"
                                                {{ old('tempat_tinggal', $gugatan->tempat_tinggal ?? '') == 'rumah_orangtua_tergugat' ? 'selected' : '' }}>
                                                Di rumah orangtua Tergugat, di desa</option>
                                            <option value="rumah_kontrakan"
                                                {{ old('tempat_tinggal', $gugatan->tempat_tinggal ?? '') == 'rumah_kontrakan' ? 'selected' : '' }}>
                                        ...
                                        <div id="desa_input" style="display: none;">
                                            <input type="text" name="desa" class="form-control mt-2"
                                                placeholder="Nama desa" value="{{ old('desa', $gugatan->desa ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="kumpul_baik_selama_tahun"
                                                    ...
                                                    placeholder="tahun"
                                                    value="{{ old('kumpul_baik_selama_tahun', $gugatan->kumpul_baik_selama_tahun ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="kumpul_baik_selama_bulan"
                                                    ...
                                                    placeholder="bulan"
                                                    value="{{ old('kumpul_baik_selama_bulan', $gugatan->kumpul_baik_selama_bulan ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="jumlah_anak" name="jumlah_anak"
                                                    ...
                                                    value="{{ old('jumlah_anak', $gugatan->jumlah_anak ?? '') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="anak_{{ $i }}"><b>{{ $i }}. Nama
                                                            Anak</b></label>
                                                    <input type="text" id="anak_{{ $i }}"
                                                        name="anak_{{ $i }}" class="form-control"
                                                        placeholder="Nama Anak"
                                                        value="{{ old('anak_' . $i, $gugatan->{'anak_' . $i} ?? '') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="tanggal_lahir_anak_{{ $i }}"><b>Tanggal
                                                            Lahir</b></label>
                                                    <input type="date" id="tanggal_lahir_anak_{{ $i }}"
                                                        name="tanggal_lahir_anak_{{ $i }}"
                                                        class="form-control"
                                                        value="{{ old('tanggal_lahir_anak_' . $i, $gugatan->{'tanggal_lahir_anak_' . $i} ?? '') }}">
                                                    <span id="error_tanggal_lahir_anak_{{ $i }}"
